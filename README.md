...
Al momento de la elaboracón del programa aprendí a:
*Creación de las interfaces gráficas utilizando Tkinter
*Trabajar con archivo JSON
*Implementación de persistencia de datos
*Manejo de errores utilizando try-except
*Organizar programas mediante varias funciones
